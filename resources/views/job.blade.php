    ...
    <div class="flex flex-col items-center w-full min-h-screen">
        ...
        <div class="flex flex-col items-center w-full">
            <div class="flex flex-col w-11/12 bg-base-200 border-t-8 border-t-violet-400 rounded-lg shadow-lg mb-10 dark:bg-slate-700">
                ...
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->description}}</pre>
                <h2 class="pt-3 pl-5 font-medium">Требования</h2>
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->requirements}}</pre>
                <h2 class="pt-3 pl-5 font-medium">Обязанности</h2>
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->responsibilities}}</pre>
                <h2 class="pt-3 pl-5 font-medium">Условия работы</h2>
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->work_conditions}}</pre>
                <h2 class="pt-3 pl-5 font-medium">Город</h2>
                <p class="pt-3 pl-5">{{$job->city->name}}</p>
                <h2 class="pt-3 pl-5 font-medium">Компания</h2>
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->company_name}}</pre>
                <h2 class="pt-3 pl-5 font-medium">Контакты</h2>
                <pre class="py-3 px-5 font-sans whitespace-pre-wrap">{{$job->contacts}}</pre>
