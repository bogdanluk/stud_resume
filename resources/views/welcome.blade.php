...
@section('content')
    ...
    <main>
        <div class="w-full min-h-screen flex flex-col justify-center items-center"
            ...
            <div class="self-center text-center w-full sm:w-2/3 xl:w-1/2 px-4 sm:px-0 animate__animated animate__fadeInDown">
            ...
            <div class="flex flex-row w-full justify-center mt-10 animate__animated animate__fadeInDown">
        ...
        <div id="features" class="w-full min-h-screen flex flex-col justify-center items-center bg-gray-200 dark:bg-slate-900 py-12">
            <div class="self-center text-center w-full sm:w-2/3 xl:w-1/2 px-4 sm:px:0 wow animate__fadeInDown">
            ...
            <div class="self-center w-full xl:w-4/5 flex flex-col sm:flex-row flex-wrap px-4 xl:px:0">
                <div class="w-full sm:w-1/2 flex flex-row flex-no-wrap hover:shadow-lg hover:bg-violet-200 hover:bg-opacity-50 px-4 sm:px-8 py-6 sm:py-12 wow animate__fadeInLeft" onclick="">
                ...
                <div class="w-full sm:w-1/2 flex flex-row flex-no-wrap hover:shadow-lg hover:bg-violet-200 hover:bg-opacity-50 px-4 sm:px-8 py-6 sm:py-12 wow animate__fadeInRight" onclick="">
                    <div class="w-1/3 text-center">
            ...
            <div class="self-center text-center w-full sm:w-1/3 px-4 sm:px:0 wow animate__fadeInDown">
                <h3 class="font-bold tracking-widest text-violet-400 text-2xl my-6">...и многое другое!</h3>
            </div>
            <div class="flex flex-row w-full justify-center pt-6 wow animate__fadeInDown">
