<div class="navbar bg-base-200 border-b-2 border-gray-200 dark:border-slate-600 dark:bg-slate-700 rounded-b-md p-2 sticky top-0">
    ...
    <div class="navbar-center hidden lg:flex dark:bg-slate-700">
        <ul class="menu-horizontal tabs tabs-boxed p-2 bg-inherit">
            ...
            @else
                <li class="tab text-xl"><a href="{{ route('admin.news-list') }}">Новости</a></li>
            @endif
            @if(request()->route()->getName() == 'admin.jobs-list')
                <li class="tab tab-active text-xl"><a href="{{ route('admin.jobs-list') }}">Вакансии</a></li>
            @else
                <li class="tab text-xl"><a href="{{ route('admin.jobs-list') }}">Вакансии</a></li>
            @endif
            @if(request()->route()->getName() == 'admin.resumes-list')
                <li class="tab tab-active text-xl"><a href="{{ route('admin.resumes-list') }}">Резюме</a></li>
            @else
                <li class="tab text-xl"><a href="{{ route('admin.resumes-list') }}">Резюме</a></li>
            @endif
        </ul>
    </div>
