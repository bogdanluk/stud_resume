    ...
    <div class="flex flex-col min-h-screen">
        <div class="flex flex-col">
            ...
            <div class="flex flex-col items-center">
                <h1 class="mt-10 mx-5 p-5 text-2xl text-center border-2 rounded-lg border-violet-400 text-violet-400 shadow-lg">Что такое «Налог на профессиональный доход»</h1>
                <div class="mx-10 mt-10 rounded-lg shadow-lg border-t-8 border-violet-400">
                    <p class="p-5">Налог на профессиональный доход — это специальный налоговый режим для самозанятых граждан, который можно применять с 2019 года. Действовать этот режим будет в течение 10 лет.
                        <br>
                        <br>Эксперимент по установлению специального налогового режима проводится на всей территории РФ.
                        <br>
                        <br>Переход на специальный налоговый режим осуществляется добровольно. У налогоплательщиков, которые не перейдут на этот налоговый режим, остается обязанность платить налоги с учетом других систем налогообложения, которые они применяют в обычном порядке.
                        <br>
                        <br>Физические лица и индивидуальные предприниматели, перешедшие на специальный налоговый режим (самозанятые), могут платить с доходов от самостоятельной деятельности налог по льготной ставке — 4 или 6%. Это позволяет легально вести бизнес и получать доход от подработок без рисков получения штрафа за незаконную предпринимательскую деятельность.</p>
                </div>
            </div>    

            <div class="flex flex-col md:flex-row justify-center flex-wrap mx-10 mt-10">
            ...
            <div class="flex flex-col items-center">
                <h1 class="mt-10 mx-5 p-5 text-2xl text-center border-2 rounded-lg border-violet-400 text-violet-400 shadow-lg">Кому подходит этот налоговый режим</h1>
                <div class="mx-10 mt-10 rounded-lg shadow-lg border-t-8 border-violet-400">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col md:flex-row justify-center flex-wrap mx-10 mt-10">
                    <div tabindex="0" class="collapse bg-violet-400 text-white rounded-box hover:cursor-pointer hover:bg-violet-600 focus:bg-violet-600 shadow-lg transition-all h-max mx-2 my-3"> 
                        <div class="collapse-title text-xl text-center font-medium p-3">
                           <p><p class="text-4xl">4%</p><br>при расчётах с физическими лицами</p> 
                        </div>
                        <div class="collapse-content bg-white text-violet-400"> 
                    ...
                    <div tabindex="0" class="collapse bg-violet-400 text-white rounded-box hover:cursor-pointer hover:bg-violet-600 focus:bg-violet-600 shadow-lg transition-all h-max mx-2 my-3"> 
                        <div class="collapse-title text-xl text-center font-medium p-3">
                            <p><p class="text-4xl">6%</p><br>при расчётах с ИП организациями</p> 
                        </div>
                        <div class="collapse-content bg-white text-violet-400"> 
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="mx-10 mt-10 rounded-lg shadow-lg border-t-8 border-violet-400">
                    ...
                    <ul class="px-5">
                        <li class="mb-5"><i class="fa-solid fa-1 pr-2 text-violet-600"></i>Физические лица не уплачивают налог на доходы физических лиц с тех доходов, которые облагаются налогом на профессиональный доход.</li>
                        <li class="mb-5"><i class="fa-solid fa-2 pr-2 text-violet-600"></i>Индивидуальные предприниматели не уплачивают:
                            <ul class="pt-3 px-5">
