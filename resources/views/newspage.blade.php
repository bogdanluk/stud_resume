...
@section('content')
    ...
    <div class="flex flex-col items-center">
      @foreach ($posts as $post)
        <div class="card mb-5 mt-5 w-3/5 lg:card-side bg-base-100 shadow-xl rounded-lg">
          <figure><img class="w-48 h-full" src="storage/news/{{ $post['image']  }}" alt="{{ $post['image']  }}"/></figure>
          <div class="card-body">
