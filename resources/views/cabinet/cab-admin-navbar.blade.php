        ...
        <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow-lg bg-base-100 dark:bg-slate-700 rounded-box w-52">
                ...
                @if(request()->route()->getName() == 'home')
                    <li class="mr-2 text-lg active p-1 hover:text-white hover:bg-violet-400 hover:rounded-lg link"><a href="{{ route('home') }}">Главная</a></li>
                @else
                ...
                @if(request()->route()->getName() == 'cabinet.news-list')
                    <li class="mr-2 text-lg active py-1 px-2 mx-2 transition-all ease-in hover:text-white hover:bg-violet-400 rounded-lg link"><a href="{{ route('cabinet.news-list') }}">Список постов</a></li>
                @else
                    <li class="mr-2 text-lg py-1 px-2 mx-2 transition-all ease-in hover:text-white hover:bg-violet-400 rounded-lg"><a href="{{ route('cabinet.news-list') }}">Список постов</a></li>
                @endif
            </ul>
        </div>
