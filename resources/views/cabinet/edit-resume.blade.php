    ...
    <main class="flex flex-col items-center w-full px-5 min-h-screen">
        ...
        <form action="{{ route('cabinet.resume.edit', $resume->id) }}" method="post" enctype="multipart/form-data" class="w-full bg-base-200 dark:bg-slate-700 p-5 rounded-md mb-5 shadow-lg">
            ...
            <textarea type="text" id="input3" name="about" placeholder="О себе"
                      class="w-full h-5 px-3 py-5 border-2 dark:border-slate-400 mt-2 outline-none focus:border-violet-400 rounded-md dark:bg-slate-800 dark:focus:border-violet-400">{{ $resume->about }}</textarea>
            ...
            <textarea type="text" id="input4" name="experience" placeholder="Опыт работы"
                      class="w-full h-5 px-3 py-5 border-2 dark:border-slate-400 mt-2 outline-none focus:border-violet-400 rounded-md dark:bg-slate-800 dark:focus:border-violet-400">{{ $resume->experience }}</textarea>
