        ...
        <div class="relative py-3 sm:w-96 mx-auto text-center">
            ...
            <div class="mt-4 bg-white shadow-lg rounded-lg text-left">
                ...
                <form class="px-8 py-6" action="#" method="post">
                    ...
                    <input type="password" id="input2" placeholder="ФИО" class="border w-full h-5 px-3 py-5 mt-2 focus:outline-none focus:ring-violet-400 focus:ring-1 rounded-md">
                    <label class="block mt-3 font-semibold" for="input3">Пароль</label>
                    <input type="password" id="input3" placeholder="Пароль" class="border w-full h-5 px-3 py-5 mt-2 focus:outline-none focus:ring-violet-400 focus:ring-1 rounded-md">
                    <label class="block mt-3 font-semibold" for="input4">Подтвердите пароль</label>
                    <input type="password" id="input4" placeholder="Подтвердите пароль" class="border w-full h-5 px-3 py-5 mt-2 focus:outline-none focus:ring-violet-400 focus:ring-1 rounded-md">
                    <div class="flex justify-between items-baseline">
                        ...
                        <a href="{{ route('login') }}" class="text-sm hover:underline">Есть аккаунт?</a>
                    </div>
                </form>
            </div>
        </div>
