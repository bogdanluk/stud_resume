...
@section('content')
    ...
    <div class="flex flex-col md:flex-row my-5 mx-5">
        <div class="flex flex-col w-2/6 h-min border-t-8 bg-base-200 border-t-violet-400 rounded-lg shadow-lg p-3">
            ...
            <form method="get" action="{{route('jobs')}}">
                <div class="flex flex-row m-3">
                    ...
                    <input type="text" name="name" placeholder="Название" class="py-2 w-full px-5 border-2 outline-none focus:border-violet-400 rounded-full cursor-pointer"/>
                </div>
                <div class="flex flex-row m-3">
                    <i class="fa-solid fa-circle-dot mt-3 text-violet-400 mr-3"></i>
                ...
                <button class="btn ml-10 mt-2 bg-violet-400 text-white ease-in hover:bg-violet-600"
