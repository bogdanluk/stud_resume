...
return [
    ...
    */
    ...
    'social_auth_success' => 'Вы вошли через соцсеть. Пожалуйста установите пароль, чтобы не потерять доступ при проблемах на стороне соцсети.',
    'social_no_email' => 'В вашей соцсети отсутствует email, авторизация невозможна.',
];
